...
(function ( document, window ) {
    ...
    var bootstrap = "css/bootstrap.css";
    ...
    var consoleTemplate = '<!DOCTYPE html>' +
        ...
        '<title>Presentation console</title>' +
        '</head><body>' +
        '<div class="wrapper">' +
        '<div class="row">' +
           '<div id="console">' +
    ...
    var impressConsole = window.impressConsole = function (rootId) {
        ...
        var nextStep = function() {
			//console.log(document.querySelector('.active').nextElementSibling);
            ...
            while (nextElement) {
				...
				if (classes && classes.value.indexOf('substep active past') !== -1) {
                   return nextElement;
                }
